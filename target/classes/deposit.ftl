            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="/myAccount/deposit">deposit</a></li>
                        <li><a href="/myAccount/withdraw">withdraw</a></li>
                        <li><a href="/myAccount/transfer">transfer</a></li>
                    </ul>
                    <br>
                    <p>
                    ...
                    <form method="post">
                        <div class="form-group">
                            <label for="depositValue">How much do you want to deposit?</label>
                            <input type="text" class="form-control" id="depositValue" name="depositValue" placeholder="input number" value="${depositValue}">
                        </div>
