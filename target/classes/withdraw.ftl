            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="/myAccount/withdraw">withdraw</a></li>
                    ...
                    <form method="post">
                        <div class="form-group">
                            <label for="withdraw">How much do you want to withdraw?</label>
                            <input type="text" class="form-control" id="withdraw" name="withdraw" placeholder="input number" value="${withdraw}">
                        </div>
